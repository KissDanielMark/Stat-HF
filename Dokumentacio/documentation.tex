...
\begin{figure}%
  \centering
  \subfloat[\centering Feladat 3/a kimenet]{{\includegraphics[width=7cm]{Figure_1.png} }}%
  \qquad
  \subfloat[\centering Feladat 3/a kimenet]{{\includegraphics[width=7cm]{Figure_2.png} }}%
...
\begin{figure}%
  \centering
  \subfloat[\centering Feladat 3/b kimenet]{{\includegraphics[width=7cm]{Figure_5.png} }}%
  \qquad
  \subfloat[\centering Feladat 3/b kimenet]{{\includegraphics[width=7cm]{Figure_6.png} }}%
